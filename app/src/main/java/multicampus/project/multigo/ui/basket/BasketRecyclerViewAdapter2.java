 ...
 */
public class BasketRecyclerViewAdapter2 extends RecyclerView.Adapter<BasketRecyclerViewAdapter2.ViewHolder> {
    ...
    public BasketRecyclerViewAdapter2(OnListFragmentInteractionListener listener, DatabaseReference ref) {
        mListener = listener;
        mDatabaseRef = ref;
